...
public class vocoid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vocoid);
        ...
        mShowDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(vocoid.this);
                View mView= getLayoutInflater().inflate(R.layout.register_cultural,null);
                ...
                ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(vocoid.this,android.R.layout.simple_spinner_item,getResources().getStringArray(R.array.branch));
                ...
                ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(vocoid.this,android.R.layout.simple_spinner_item,getResources().getStringArray(R.array.year));
                ...
                dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        databaseReference = FirebaseDatabase.getInstance().getReference("Cultural");
                        ...
                        if(!mFname.getText().toString().isEmpty() && !mRegno.getText().toString().isEmpty() && !spinner1.getSelectedItem().toString().equalsIgnoreCase("Branch") && !spinner2.getSelectedItem().toString().equalsIgnoreCase("Year") && !mphone.getText().toString().isEmpty() && !mRegno.getText().toString().isEmpty() && !mFname.getText().toString().isEmpty() && !memail.getText().toString().isEmpty() && !mFname.getText().toString().isEmpty() && !Events.isEmpty() ){
                            ...
                            Toast.makeText(vocoid.this, "Please fill empty fields", Toast.LENGTH_SHORT).show();
        ...
        switch (view.getId()){
            ...
            case R.id.checkBox1:
                if (checked) {
                    ...
                    selection.add("Dance-A-Thon");
                }
                else {
                    selection.remove("Dance-A-Thon");
                }
                break;
            ...
            case R.id.checkBox2:
                if (checked) {
                    ...
                    selection.add("Dueto-Voco");
                }
                else {
                    selection.remove("Dueto-Voco");
                }
                break;
            ...
            case R.id.checkBox3:
                if (checked) {
                    ...
                    selection.add("NIT-Got Talent");
                }
                else {
                    selection.remove("NIT-Got Talent");
                }
                break;
            ...
            case R.id.checkBox4:
                if (checked) {
                    ...
                    selection.add("Rangoli");
                }
                else {
                    selection.remove("Rangoli");
                }
                break;
            ...
            case R.id.checkBox5:
                if (checked) {
                    ...
                    selection.add("Voca-idolo");
                }
                else {
                    selection.remove("Voca-idolo");
                }
                break;
