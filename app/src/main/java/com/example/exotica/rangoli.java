    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(rangoli.this);
                ...
                ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(rangoli.this,android.R.layout.simple_spinner_item,getResources().getStringArray(R.array.branch));
                ...
                ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(rangoli.this,android.R.layout.simple_spinner_item,getResources().getStringArray(R.array.year));
                ...
                dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(!mFname.getText().toString().isEmpty() && !mRegno.getText().toString().isEmpty() && !spinner1.getSelectedItem().toString().equalsIgnoreCase("Branch") && !spinner2.getSelectedItem().toString().equalsIgnoreCase("Year") && !mphone.getText().toString().isEmpty() && !mRegno.getText().toString().isEmpty() && !mFname.getText().toString().isEmpty() && !memail.getText().toString().isEmpty() && !mFname.getText().toString().isEmpty() && !Events.isEmpty() ){
                            ...
                            Toast.makeText(rangoli.this, "Please fill empty fields", Toast.LENGTH_SHORT).show();
