    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(musical.this);
                View mView= getLayoutInflater().inflate(R.layout.register_sports,null);
                ...
                ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(musical.this,android.R.layout.simple_spinner_item,getResources().getStringArray(R.array.branch));
                ...
                ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(musical.this,android.R.layout.simple_spinner_item,getResources().getStringArray(R.array.year));
                ...
                dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(!mFname.getText().toString().isEmpty() && !mRegno.getText().toString().isEmpty() && !spinner1.getSelectedItem().toString().equalsIgnoreCase("Branch") && !spinner2.getSelectedItem().toString().equalsIgnoreCase("Year") && !mphone.getText().toString().isEmpty() && !mRegno.getText().toString().isEmpty() && !mFname.getText().toString().isEmpty() && !memail.getText().toString().isEmpty() && !mFname.getText().toString().isEmpty() && !Events.isEmpty() ){
                            ...
                            Toast.makeText(musical.this, "Please fill empty fields", Toast.LENGTH_SHORT).show();
        ...
        switch (view.getId()){
            ...
            case R.id.checkBox1:
                if (checked) {
                    ...
                    selection.add("Carrom");
                }
                else {
                    selection.remove("Carrom");
                }
                break;
            ...
            case R.id.checkBox3:
                if (checked) {
                    ...
                    selection.add("Counter-Strike");
                }
                else {
                    selection.remove("Counter-Strike");
                }
                break;
            ...
            case R.id.checkBox5:
                if (checked) {
                    ...
                    selection.add("musical");
                }
                else {
                    selection.remove("musical");
                }
                break;
            ...
            case R.id.checkBox6:
                if (checked) {
                    ...
                    selection.add("Table-Tennis");
                }
                else {
                    selection.remove("Table-Tennis");
                }
                break;
            ...
            case R.id.checkBox7:
                if (checked) {
                    ...
                    selection.add("Musical-chair");
                }
                else {
                    selection.remove("Musical-chair");
                }
                break;
        }
